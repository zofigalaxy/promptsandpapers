...
This is an LLM-based project developed to help researchers tackle daily inflow of scientific papers. You describe your research interests, your prompt gets fed to the LLM which finds the right papers for you 
and sends them to your inbox regularly. This approach works very well for nuanced and niche fields, where simple keyword search or embeddings-based approaches don't classify papers with enough detail. 
...
reasoning that explains why the model thinks the papers is relevant to you. This can help you understand how the model makes the decision and refine your prompt.
